...
function WorkflowStep({ step }) {
  return (
    <div className='text-center flex flex-col items-center justify-center'>
      <div className='h-40 sm:h-44 md:h-52 mb-6'>
      ...
      <p className='mt-4 text-[15px] sm:text-[16px] leading-6 md:leading-7.3 max-w-xl px-4 sm:px-0 mx-auto text-[#99A1AF]'>{step.description}</p>
    </div>
  )
}
