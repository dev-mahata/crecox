  ...
  return (
    <section className='min-h-[80vh] flex items-center justify-center py-24'>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-[572px_500px] items-center gap-16">

          {/* LEFT CONTENT */}
          <div className="hero-content max-h-114">
            ...
            {/* Heading */}
            <h1 className='font-secondary text-[68px] font-normal leading-22.5'>
              Where Music
            </h1>
            <h1 className='font-secondary mb-6 text-[68px] font-normal leading-22.5 bg-linear-to-r from-[#7338EC] via-[#C25CF5] to-[#FBDAAF] bg-clip-text text-transparent'>
              Meets Movement
            </h1>

            {/* Description */}
            <p className='text-[#E5E7EB] text-[18px] leading-[32.5px] mb-6'>
              Where fans, creators, and artists build music trends together
            </p>
            <p className='text-[#99A1AF] text-[16px] leading-[29.25px]'>
            ...
            <div className="hero-buttons mt-10 flex gap-4">
              <div className="relative inline-block">
                <div className="absolute inset-0 blur-3xl opacity-70 bg-linear-to-r from-[#FBDAAF] via-[#C25CF5] to-[#7338EC] rounded-full"></div>
    ...
    text-white text-[16px] bg-white/10 font-medium border border-white/20 cursor-pointer"
          ...
          {/* RIGHT IMAGES */}
          <div className="hero-images max-w-100 max-h-100 grid grid-cols-2 justify-self-end">
